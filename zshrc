...
if [ $(hostname) = 'lisa' ]; 
then
    source /mnt/raid0/Pessoal/Documents/CLI/dotfiles/credentials/elsevier.sh
elif [ $(hostname) = 'SurfacePro8' ]; 
then
    source /mnt/c/Users/roney/Onedrive\ -\ ufmt.br/Pessoal/Documents/CLI/dotfiles/credentials/elsevier.sh
else 
    source $HOME/Documents/CLI/dotfiles/credentials/elsevier.sh
fi
...
alias verb='cat $HOME/Pessoal/CLI/verbs.md | fzf --multi --ansi --preview-window=:hidden'
...
if [ $(hostname) = 'lisa' ]; then
    ...
    alias dot='cd /mnt/raid0/Pessoal/Documents/CLI/dotfiles'
    ...
    alias dot='cd /mnt/c/Users/roney/Onedrive\ -\ ufmt.br/Pessoal/Documents/CLI/dotfiles'
    ...
    alias dot='cd ~/Documents/CLI/dotfiles'
